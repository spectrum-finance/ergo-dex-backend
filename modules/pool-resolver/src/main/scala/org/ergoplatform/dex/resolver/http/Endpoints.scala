...
import org.ergoplatform.ergo.state.PredictedIndexed
...
object Endpoints {
  ...
  def putPredicted: Endpoint[PredictedIndexed[CFMMPool], HttpError, Unit, Any] =
    endpoint.post
      .in("predicted")
      .in(jsonBody[PredictedIndexed[CFMMPool]])
