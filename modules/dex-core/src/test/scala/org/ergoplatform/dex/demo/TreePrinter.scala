...
object TreePrinter extends App {
  ...
  val env = Map(
    "BaseAmount" -> 10009L,
    "MinQuoteAmount" -> 100010L,
    "DexFeePerTokenDenom" -> 998,
    "DexFeePerTokenNum" -> 997,
    "FeeNum" -> 994,
    "RedeemerPropBytes" -> PubKey
      .unsafeFromString("026329ce69c270a944ff7c6ba6eef00b2e4fd9e5f32f8ebac8f45862f2cadd6be2")
      .toErgoTree
      .bytes,
    "RefundProp" -> false,
...
//  printTree("deposit", n2tContracts.deposit)
  printTree("swapBuyV2", t2tContracts.swapV2)
