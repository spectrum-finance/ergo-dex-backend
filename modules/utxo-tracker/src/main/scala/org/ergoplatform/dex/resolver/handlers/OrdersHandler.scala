package org.ergoplatform.dex.resolver.handlers
...
import org.ergoplatform.dex.resolver.domain.errors.InvalidOrder
import org.ergoplatform.dex.resolver.parsers.orders.OrdersOpsParser
...
](implicit producer: Producer[OrderId, AnyOrder, F], orders: OrdersOpsParser[CT, G]) {
...
object OrdersHandler {
  ...
  ](implicit producer: Producer[OrderId, AnyOrder, F], orders: OrdersOpsParser[CT, G], logs: Logs[I, G]): I[BoxHandler[F]] =
